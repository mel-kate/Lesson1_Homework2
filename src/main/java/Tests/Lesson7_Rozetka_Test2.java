...
public class Lesson7_Rozetka_Test2 {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void testFirst() {
        ...
        WebElement searchEl7 = driver.findElement(login);
        wait.until(ExpectedConditions.elementToBeClickable(searchEl7));
        String text3 = searchEl7.getText();
        String check3 = "";
        assertTrue(text3.contains(check3));
